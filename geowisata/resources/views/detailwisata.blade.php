...
" src="{{ asset('img/' . $wisata->gambar) }}"
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="hidden" id="destinationLat" value="{{ $wisata->latitude }}">
                                <input type="hidden" id="destinationLng" value="{{ $wisata->longitude }}">
                                <div class="flex">
                                    ...
                                    <button
                                        ...
                                        <a href="{{ route('dapatkanarah', ['id' => $wisata->id]) }}"> Tunjukkan
                                            Arah</a>
                                    </button>
