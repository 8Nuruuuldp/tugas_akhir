        ...
        <div class="max-w-screen-xl mx-auto sm:p-10 md:p-16 bg-green-900">
            <div class="grid grid-cols-1 md:grid-cols-4 sm:grid-cols-3 gap-8 p-8">
                ...
                <div class="bg-white rounded flex flex-col justify-between leading-normal">
                    <img src="https://images.unsplash.com/photo-1683471619890-fb7e51c3201c?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                        class="w-500 rounded">
                    <div class="p-4 pt-2">
                        <div class="mb-8">
                        ...
                        <button type="button"
                            class="text-slate-800 text-sm hover:bg-green-800 hover:text-white border border-slate-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5 text-center inline-flex items-center">
                            Lihat Selengkapnya
                            <svg class="w-3.5 h-3.5 ms-2 text-gray-800 dark:text-slate-900" aria-hidden="true"
